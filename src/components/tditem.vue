<template>
  <li>
    <label>
      <div v-for="(todos,index) in $store.state.todos" >
      <span>{{$store.state.todos[index].item}}</span>
      <input type="checkbox" :checked="$store.state.todos[index].done" @click="handlecheck(index)" />
